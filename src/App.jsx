    ...
    <div>
      <header className="header">
        <div className="navbar">
          <img src="https://static.wixstatic.com/media/7e1f44_2fc0b74f7c7e473faaca069320a3d94f~mv2.png/v1/crop/x_0,y_7,w_1041,h_221/fill/w_848,h_170,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/swnw%20logo%20white%20font.png" alt="Stageworks Logo" className="h-10" />
          <nav>
            <Link to="/">Home</Link>
